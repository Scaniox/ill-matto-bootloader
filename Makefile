...
COMPILE = avr-gcc -Wall -Os -Iusbdrv -I. -mmcu=$(TARGET) -Ttext=0x1E000 # -DDEBUG_LEVEL=2
...
clean:
	rm -f main.hex main.lst main.obj main.cof main.list main.map main.eep.hex main.bin *.o main.s usbdrv/*.o uart.o
